  ...
  return (
    <div className="container" style={{ padding: '3rem 0' }}>
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <p>
          If you have questions about this policy or your data rights, please contact us at: <a href={`mailto:${siteConfig.contact.email}`} style={{ color: 'var(--apple-blue)', textDecoration: 'none' }}>{siteConfig.contact.email}</a>
        </p>
      </div>
